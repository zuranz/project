...
@section('content')
    ...
    <div class="blog-posts">
        ...
        <div class="last-article">
            <p class="artext">{{$article->description}}</p>
            <h3></h3>
            <image></image>
            <p class="artext">{{$article->content}}</p>
            <p class="artext"></p>
            <ul class="categories">
            ...
            <div class="coment-form">
                ...
                @else
                    <p class="artext">Оставлять комментарии могут только зарегистрированные пользователи</p>
                @endif
